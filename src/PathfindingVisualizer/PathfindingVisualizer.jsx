...
export default class PathfindingVisualizer extends Component {
  ...
  visualizeDijkstra() {
    this.setState({ topMessage: "Creator : Pranjal" });
  ...
  render() {
    ...
    let button_task = (
      <p className="btn" style={{fontSize:20}}onClick={() => this.visualizeDijkstra()}>
    ...
    } else if (topMessage === "Creator : Pranjal") {
    ...
    let textBox = (
      <div className="textBox">
        <div className="weightContainer" style={{fontsize:20}}>
          <label  htmlFor="quantity">
          Toggle or Set Weight </label>
    ...
    return (
      <div className="pathfindingVisualizer">
        <div className="container">
          ...
          <p style={{fontFamily:"cursive",fontSize:20,padding:20}}>
        ...
        <p className="paragraph">Made By <a href="https://www.linkedin.com/in/pranjal-dwivedi-181285177/">Pranjal Dwivedi</a></p>
      </div>
    );
  }
}
